...
public class Note {
    ...
    public Note(String m_Zagolovok, String m_Today, String m_Thanks, String m_Task, String m_Sleep, String m_Mood, String m_Date, String[] m_Tag, StatusNote m_NoteStatus, String uniqueID, String m_Lucky, Boolean m_switchMode) {
        ...
        this.m_SwitchMode = m_switchMode;
    }
    ...
    public void setSwitchMode(Boolean m_switchMode) {
        this.m_SwitchMode = m_switchMode;
    }
}
